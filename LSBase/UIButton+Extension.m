...
//石种筛选文字图片设置
-(void)setStoneScreenBtnEdgeInsets{
...
//    UIEdgeInsets imageEdgeInsets = UIEdgeInsetsMake(titleHeight - imageHeight - 5, titleWidth + 10 / 2, 0, -titleWidth);
//    UIEdgeInsets titleEdgeInsets = UIEdgeInsetsMake(0, -imageWidth - 10 / 2, 0, imageWidth);
    
    UIEdgeInsets imageEdgeInsets = UIEdgeInsetsMake(titleHeight - imageHeight - 5, titleWidth, 0, -titleWidth);
    UIEdgeInsets titleEdgeInsets = UIEdgeInsetsMake(0, -imageWidth, 0, imageWidth);
